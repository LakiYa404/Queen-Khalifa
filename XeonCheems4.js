...
reply(`\`\`\`「 Hehe😒🍆 Dont put Group Links l 」\`\`\`\n\nYou won't be kicked by Khalifa because what you send is a link to this group`)
...
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Group Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Pala Besic Puta 😂`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
}
  // Antiwame by xeon
...
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} ලින්ක් දාන්න එපා වස්තු🍆😒`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
...
`.trim(), m, { mentions: [roof.p, roof.p2] })
	    ...
	    for (let jid of mentionUser) {
            ...
            reply(`
Don't tag him!
He's in Offline ${reason ? 'dengan alasan ' + reason : 'no reason'}
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     await XeonBotInc.send5ButImg(from, `` + '' + teksehmazeh, `© ${botname}`, XeonBotInc, [{"urlButton": {"displayText": "YᴏᴜТᴜʙᴇ","url": `${websitex}`}}])
  }
  break
        case 'userlimit': 
        if (isBan) return reply(mess.ban)	 			
...
case 'dare':
    ...
    "say i love the bot owner LakiYa through voice note",
...
if (isBanChat) return reply(mess.banChat)
let buttons = [
{buttonId: `menu`, buttonText: {displayText: 'Ｑᴜꫀꫀꪀ Mꫀꪀᴜ'}, type: 1}
]
let buttonMessage = {
video: {url:args[0]},
caption: "Done!",
...
XeonBotInc.sendMessage(from, { react: { text: `${global.reactmoji}`, key: m.key }})
	                let btn = [{
                                ...
                                quickReplyButton: {
                                    displayText: 'Λʟʟ Mᴇɴᴜ',
                                    id: 'allmenu'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'List Khalifa',
                                    id: 'command'
                                }  
                            }, {
                                quickReplyButton: {
                        ...
                        let buttonmenu = [
        	{ urlButton: { displayText: `YᴏᴜТᴜʙᴇ`, url : `${websitex}` } },
            { urlButton: { displayText: `Sᴄʀɪᴘᴛ`, url: `${botscript}` } },
            { quickReplyButton: { displayText: `Λʟʟ Mᴇɴᴜ`, id: 'allmenu'} },
            { quickReplyButton: { displayText: `List Khalifa`, id: 'command'} },
            { quickReplyButton: { displayText: `Oᴡɴᴇʀ 💋`, id: 'owner'} }
        	]
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    ...
                    sections: [{
					"title": "𝗙𝗲𝗮𝘁𝘂𝗿𝗲𝘀 𝗢𝗙 𝗤𝘂𝗲𝗲𝗻-𝗞𝗵𝗮𝗹𝗶𝗳𝗮💋",
...

							{
								...
								"rows": [

									{
										...
										"description": "Qᴜᴇᴇɴ-Kʜᴀʟɪꜰᴀ Oᴡɴᴇʀꜱ!!",
										"rowId": `${prefix}tqtt`
									}
								]
							}
...
├🧩 ${prefix}request
├🧩 ${prefix}report [bug]
╰─────────────©` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "YᴏᴜТᴜʙᴇ","url": `${websitex}`}},{"urlButton": {"displayText": "Sᴄʀɪᴘᴛ","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Dᴏɴᴀᴛᴇ","id": 'donate'}},{"quickReplyButton": {"displayText": "Oᴡɴᴇʀ 💋","id": 'owner'}}] )
break
case 'ownermenu':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
var unicorn = await getBuffer(picak+'Owner Menu')
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗢𝗪𝗡𝗘𝗥 」	
├🧩 ${prefix}self
├🧩 ${prefix}public
├🧩 ${prefix}antitag
├🧩 ${prefix}ban [add/del]
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗥𝗣𝗚 」	
├🧩${prefix}hunt
├🧩${prefix}mine
├🧩${prefix}fish
├🧩${prefix}heal
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗟𝗢𝗚𝗢 」	
├🧩${prefix}candy
├🧩${prefix}8bit
├🧩${prefix}horror
├🧩${prefix}hoorror
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗 」	
├🧩${prefix}instagram [url]
├🧩${prefix}igtv [url]
├🧩${prefix}igstory [username]
├🧩${prefix}facebook [url]
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗦𝗘𝗔𝗥𝗖𝗛 」	
├🧩${prefix}play [query]
├🧩${prefix}song [query]
├🧩${prefix}yts [query]
├🧩${prefix}lyrics [query]
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗖𝗢𝗡𝗩𝗘𝗥𝗧 」	
├🧩 ${prefix}toimage [reply stick]
├🧩 ${prefix}sticker [reply img|gif]
├🧩 ${prefix}take [reply img|gif|stik]
├🧩 ${prefix}smeme [reply img]
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗥𝗔𝗡𝗗𝗢𝗠 𝗜𝗠𝗚 」	
├🧩${prefix}coffee
├🧩${prefix}bts
├🧩${prefix}woof
├🧩${prefix}meow
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗘𝗠𝗢𝗧𝗘𝗦 」	
├🧩${prefix}instagramemoji
├🧩${prefix}facebookemoji
├🧩${prefix}iphoneemoji
├🧩${prefix}samsungemoji
...
await XeonBotInc.send5ButImg(from, `╭─────©「 𝗜𝗠𝗚 𝗘𝗗𝗜𝗧𝗜𝗡𝗚 」	
├🧩${prefix}wanted
├🧩${prefix}blur
├🧩${prefix}framed
├🧩${prefix}gayeffect
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗔𝗡𝗜𝗠𝗘 」	
├🧩${prefix}naruto
├🧩${prefix}yaoi
├🧩${prefix}neko2
├🧩${prefix}waifu
...
await XeonBotInc.send5ButImg(from, `╭───────©「 ස්ටිකර් සෑදීමට 」	
├🧩 ${prefix}patrick
├🧩 ${prefix}emoji
├🧩 ${prefix}emojimix
├🧩 ${prefix}attp
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗔𝗡𝗜𝗠𝗘 𝗦𝗧𝗜𝗖. 」	
├🧩${prefix}loli
├🧩${prefix}bully
├🧩${prefix}cuddle
├🧩${prefix}cry
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗞𝗛𝗔𝗟𝗜𝗙𝗔 」	
├🧩${prefix}hentaivideo
├🧩${prefix}yuri
├🧩${prefix}masturbation
├🧩${prefix}thighs
...
await XeonBotInc.send5ButImg(from, `╭───────©「 *ආතල් මෙනුව  👄*」	
├🧩 ${prefix}how [text
├🧩 ${prefix}when [text]
├🧩 ${prefix}where [text]
├🧩 ${prefix}is [text]
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗦𝗢𝗨𝗡𝗗𝗦 」	
├🧩 ${prefix}sound1
├🧩 ${prefix}sound2
├🧩 ${prefix}sound3
├🧩 ${prefix}sound4
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗚𝗔𝗠𝗘𝗦 」	
├🧩 ${prefix}truth
├🧩 ${prefix}dare
├🧩 ${prefix}tictactoe
├🧩 ${prefix}delttt
...
await XeonBotInc.send5ButImg(from, `╭───©「 𝗔𝗡𝗢𝗡𝗬𝗠𝗢𝗨𝗦 」	
├🧩${prefix}anonymous
├🧩${prefix}start
├🧩${prefix}next
├🧩${prefix}leave
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗧𝗢𝗢𝗟𝗦 」	
├🧩 ${prefix}translate [text]
├🧩 ${prefix}fliptext [text]
├🧩 ${prefix}toletter [number]
╰─────────────©` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "YᴏᴜТᴜʙᴇ","url": `${websitex}`}},{"urlButton": {"displayText": "Sᴄʀɪᴘᴛ","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Dᴏɴᴀᴛᴇ","id": 'donate'}},{"quickReplyButton": {"displayText": "Oᴡɴᴇʀ 💋","id": 'owner'}}] )
...
await XeonBotInc.send5ButImg(from, `╭───©「 𝗗𝗔𝗧𝗔𝗕𝗔𝗦𝗘 」	
├🧩 ${prefix}setcmd
├🧩 ${prefix}listcmd
├🧩 ${prefix}delcmd
├🧩 ${prefix}lockcmd
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗛𝗘𝗛𝗘👄 」	
├🧩 ${prefix}darkjoke
├🧩 ${prefix}quotes
├🧩 ${prefix}animequotes
├🧩${prefix}jalantikus-meme
...
await XeonBotInc.send5ButImg(from, `╭─©「 𝗛𝗢𝗥𝗢𝗦𝗖𝗢𝗣𝗘 」	
├🧩${prefix}nomorhoki
├🧩${prefix}artimimpi 
├🧩${prefix}artinama 
├🧩${prefix}ramaljodoh 
...
await XeonBotInc.send5ButImg(from, `╭───────©「 𝗢𝗧𝗛𝗘𝗥  」	
├🧩 ${prefix}afk
├🧩 ${prefix}readmore [text]
├🧩 ${prefix}toviewonce
├🧩 ${prefix}chatinfo
